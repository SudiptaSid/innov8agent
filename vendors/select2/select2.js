...
!(function (n) {
    ...
    ((e = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : e) && e.requirejs) ||
        ...
        e.define("select2/results", ["jquery", "./utils"], function (u, d) {
            ...
            return (
                ...
                (s.prototype.option = function (e) {
                    ...
                    if (e.children) {
                        for (
                            var i = u(n), o = document.createElement("strong"), r = ((o.className = "select2-results__group"), this.template(e, o), []), a = 0;
                            a < e.children.length;
                            a++
                        ) {
                            var l = e.children[a],
            ...
            return (
                ...
                (i.prototype.render = function () {
                    ...
                    return (
                        ...
                        e.html('<span class="select2-selection__rendered"></span><span class="select2-selection__arrow" role="presentation"></span>'),
                        e
                    );
                }),
                ...
                (e.prototype.bind = function (e, t, n) {
                    ...
                    e.call(this, t, n),
                        t.on("*", function (e, t) {
                            var n;
                            -1 !== i.indexOf(e) &&
                                ((n = r.Event("select2:" + e, { params: (t = t || {}) })), s.$element.trigger(n), -1 !== o.indexOf(e)) &&
                ...
                (n.prototype.item = function (e) {
                    ...
                    if (null == (t = a.GetData(e[0], "data"))) {
                        ...
                        if ("option" === n.tagName.toLowerCase())
                            ...
                            for (
                                var t = { text: e.prop("label"), children: [], title: e.prop("title") }, s = e.children("option"), i = [], o = 0;
                                o < s.length;
                                o++
                            ) {
                                var r = l(s[o]),
            ...
            return (
                ...
                (e.prototype.tokenizer = function (e, t, n, s) {
                    for (
                        ...
                        -1 === i.indexOf(l)
                            ? r++
                            : ((l = o.substr(0, r)), null == (l = a(c.extend({}, t, { term: l }))) ? r++ : (s(l), (o = o.substr(r + 1) || ""), (r = 0)));
                    }
                    return { term: o };
                }),
                e
        ...
        e.define(
            ...
            function (l, o, r, a, c, u, d, p, h, f, g, t, m, y, v, _, b, $, w, x, A, D, S, E, O, C, L, T, q, I, e) {
                function n() {
                    this.reset();
                }
                return (
