                    ...
                    if ("table" != this.nodeName.toLowerCase()) W(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                        ...
                        var S = h.oFeatures,
                            t = function () {
                                ...
                                if (
                                    (0 ===
                                        (n = 0 === n.length && 0 < e.length && ("" !== h.oScroll.sX || "" !== h.oScroll.sY) ? P("<tfoot/>").appendTo(l) : n)
                                            .length || 0 === n.children().length
        ...
        Ne =
            ...
            (w.defaults = {
                ...
                oLanguage: {
                    ...
                    oPaginate: { sFirst: "First", sLast: "Last", sNext: "<em class='icon-angleRight'></em>", sPrevious: "<em class='icon-angleLeft'></em>" },
            ...
            P.extend(w.ext.classes, {
                ...
                sPaging: "dataTables_paginate paginationSec paging_",
